...
public abstract class AbstractThesisService<S, T, A> implements AutoCloseable {
     ...
     */
    public abstract S createStudent(Long aisId, String name, String email, String password, Optional<Integer> year, Optional<Integer> term, Optional<String> programme);
     ...
     */
    public abstract T createTeacher(Long aisId, String name, String email, String password, Optional<String> department, Optional<String> institute);
     ...
     */
    public abstract A makeThesisAssignment(Long supervisor, String title, ThesisType type, String registrationNumber, Optional<String> description);
